...
NOTEBOOKS_TO_CHECK = [
    ROOT / "notebooks" / "01_data_exploration_preprocessing.ipynb",
    ROOT / "notebooks" / "02_model_screening.ipynb",
...
REQUIRED_MARKERS_MAIN_NOTEBOOK = [
    "GROUP_COL",
    "TARGET",
    "FEATURES",
    "CFG",
...
def check_notebook(path: Path):
    ...
    if path.name == "03_reproduce_review_core_results.ipynb":
        for marker in REQUIRED_MARKERS_MAIN_NOTEBOOK:
